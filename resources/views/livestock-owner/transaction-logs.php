<?php
/**
 * Transaction Logs - Livestock Owner
 */
...
// Build query
$where  = ['tl.livestock_owner_id = ?'];
$params = [$owner['id']];
$types  = 'i';

if ($filter_supplier !== '') {
    $where[]  = 'tl.supplier_name LIKE ?';
...
$totalSpent = array_sum(array_column($logs, 'subtotal'));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .tl-filters input:focus, .tl-filters select:focus {
            outline: none; border-color: var(--primary-color, #c0392b); background: #fff;
        }
        .btn-filter {
...
<div class="dashboard-layout">
    ...
    <div class="tl-wrap">
        ...
        <div class="tl-header">
            ...
            <p>All your feed purchase transactions</p>
        </div>
        ...
        <div class="tl-summary">
            ...
            <div class="tl-sum-card">
                ...
                <div class="lbl">Total Feed Purchased</div>
            </div>
            <div class="tl-sum-card">
                <div class="val">₱<?php echo number_format($totalSpent, 2); ?></div>
                <div class="lbl">Total Amount Spent</div>
            </div>
        </div>
        ...
        <form method="GET" action="">
            <div class="tl-filters">
                ...
                <a href="/LechGo_Final/public/livestock-owner/transaction-logs" class="btn-clear">✕ Clear</a>
            </div>
        </form>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong><?php echo htmlspecialchars($log['supplier_name']); ?></strong></td>
                ...
                <tfoot>
                    <tr style="background:#fdf0f0;">
                        ...
                        <td></td>
                        <td style="padding:10px 14px;font-weight:800;color:#c0392b;">₱<?php echo number_format($totalSpent, 2); ?></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
